...
- For literature search use these tools in order of preference: web_search, google_web_search, PubMed_search_articles, ArXiv_search_papers, SemanticScholar_search_papers, PMC_search_papers, EuropePMC_search_articles, advanced_literature_search_agent.
- If unsure of the exact tool name, call Tool_Finder or Tool_Finder_Keyword first to discover available tools.
- If a tool call fails with "not found", immediately try the next tool in the list. Do NOT stop or report the error to the user.
