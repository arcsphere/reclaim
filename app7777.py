...
- IMPORTANT: All ToolUniverse tools must be called with the prefix "mcp_tooluniverse_". For example: mcp_tooluniverse_web_search, mcp_tooluniverse_google_web_search, mcp_tooluniverse_PubMed_search_articles, mcp_tooluniverse_ArXiv_search_papers, mcp_tooluniverse_SemanticScholar_search_papers, mcp_tooluniverse_PMC_search_papers, mcp_tooluniverse_EuropePMC_search_articles, mcp_tooluniverse_advanced_literature_search_agent, mcp_tooluniverse_Tool_Finder.
- If a tool call fails, try the next one in the list. Never stop on a single tool failure.
...
def analyze():
    ...
    custom_questions = json.loads(request.form.get("customQuestions", "[]"))
