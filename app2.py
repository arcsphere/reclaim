...
- Prefer these tools for literature search: web_search, google_web_search, PubMed_search_articles, ArXiv_search_papers, SemanticScholar_search_papers. Do NOT use openalex_search_works.
